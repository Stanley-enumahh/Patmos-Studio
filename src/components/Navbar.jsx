...
export const Navbar = ({ isOpen, onIsOpen }) => {
  return (
    <div className="w-full bg-transparent h-fit py-6 md:py-4 flex justify-center fixed top-0 left-0 z-50">
      <div className="w-[88%] md:w-[85%] flex flex-row items-center justify-between">
        <div className="backdrop-blur-lg p-3 rounded-full overflow-hidden">
          <img
            src={Logo}
        ...
        <div className=" md:bg-basic-color  w-fit box p-1 flex flex-row h-[30px] md:h-[45px] rounded-3xl items-center justify-between md:w-fit">
          ...
          <div className="md:hidden flex burger ml-[53px] backdrop-blur-lg p-3 rounded-full md:ml-0">
            {isOpen ? (
              <HiMiniXMark
                onClick={onIsOpen}
          ...
          <button className="bg-black hover:bg-gray-500 transition-all duration-200 md:flex hidden text-sm text-white justify-center items-center h-[24px] md:h-[39px] w-[53px] md:w-[109px] rounded-3xl">
            Get started
          </button>
        </div>
      </div>
